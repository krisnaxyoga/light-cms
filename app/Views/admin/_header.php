...
$navItems = [
    ...
    ['url' => 'admin/languages',    'label' => 'Languages',      'icon' => 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9'],
    ['url' => 'admin/homepage',     'label' => 'Homepage',       'icon' => 'M12 4.5l8 6.5h-2.5v8h-11v-8H4l8-6.5z'],
    ['url' => 'admin/menus',        'label' => 'Menus',          'icon' => 'M4 6h16M4 12h10m-10 6h16'],
    ...
    ['url' => 'admin/deploy',       'label' => 'Deploy',         'icon' => 'M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z'],
